...
public class BookNameAdapter extends ArrayAdapter<Book> {

    public Context mContext;
    public List<Book> booksList = new ArrayList<>();

    public BookNameAdapter(@NonNull Context context,  ArrayList<Book> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView name = (TextView) listItem.findViewById(R.id.textView_bookname);
