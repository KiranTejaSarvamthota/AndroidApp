...
public class SearchByBookName  extends AppCompatActivity {
    ...
    BookNameAdapter bookNameAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_book_name);

        listView=(ListView)findViewById(R.id.bybooknamelistview);

        editText=(EditText)findViewById(R.id.bookname_search);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent= new Intent(SearchByBookName.this, BookDetails.class);
    ...
    public void searchItem(String textToSearch){
        ...
        for(Book item:items){
            ...
            Log.i("sarvam1",item.getbName());


            if(!item.getbName().contains(textToSearch)){
    ...
    public void initList(){
        ...
        bookNameAdapter=new BookNameAdapter(this, listItems);
